...
globalDefine('vs/nls.messages-loader', [], function (...args) {
    return {
        load: (name, req, load, config) => {
            var _a, _b;
            const requestedLanguage = (_b = (_a = config['vs/nls']) === null || _a === void 0 ? void 0 : _a.availableLanguages) === null || _b === void 0 ? void 0 : _b['*'];
...
globalDefine('vs/nls.messages', ['require', 'exports', 'vs/nls.messages-loader!'], function (require, exports) {
...
define.amd = true;
//# sourceMappingURL=nls-fix.js.map