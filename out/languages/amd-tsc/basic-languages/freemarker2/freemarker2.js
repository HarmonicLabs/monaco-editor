...
define(["require", "exports", "../../fillers/monaco-editor-core"], function (require, exports, monaco_editor_core_1) {
                    ...
                    [
                        /[\[\]\(\)\{\}]/,
                        {
                            cases: {
                                ...
                                '\\]': {
                                    cases: Object.assign(Object.assign(Object.assign({}, (is.id === 'bracket'
                                        ? {
                                        ...
                                        [s('$S1==inParen__id__')]: { token: '@brackets', next: '@pop' }, '@default': { token: '@brackets' } })
                                },
                                ...
                                '\\}': {
                                    cases: Object.assign(Object.assign({}, (is.id === 'bracket'
                                        ? {}
                                        : {
                                            '$S2==interpolation': { token: '@brackets.interpolation', next: '@popall' }
                                        })), { 
    ...
    function createMonarchLanguageAuto(is) {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign({}, angle), bracket), auto), { 
            // Settings
            unicode: true, includeLF: false, start: `default_auto_${is.id}`, ignoreCase: false, defaultToken: 'invalid', tokenPostfix: `.freemarker2`, brackets: [
                { open: '{', close: '}', token: 'delimiter.curly' },
                { open: '[', close: ']', token: 'delimiter.square' },
                { open: '(', close: ')', token: 'delimiter.parenthesis' },
                { open: '<', close: '>', token: 'delimiter.angle' }
            ], tokenizer: Object.assign(Object.assign(Object.assign({}, angle.tokenizer), bracket.tokenizer), auto.tokenizer) });
    }
